...
- On the pair pages, the ad slot sits **after `</article>`**, outside the block regenerated by `.claude/build_static_pages.py`; keep it there when regenerating.
